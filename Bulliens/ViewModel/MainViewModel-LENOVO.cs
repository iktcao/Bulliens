...
using SteamDome.Helper;
using SteamDome.Models;

namespace SteamDome.ViewModel
{
    ...
    public class MainViewModel : ViewModelBase, IDataErrorInfo
    {
        ...
        {
            get { return WaterCycle.WaterViscosity; }
            set
            {
                WaterCycle.WaterViscosity = value;
        ...
        {
            get { return WaterCycle.SteamViscosity; }
            set
            {
                WaterCycle.SteamViscosity = value;
        ...
        {
            get { return WaterCycle.Roughness; }
            set
            {
                WaterCycle.Roughness = value;
        ...
        public String this[string columnName]
        {
            get
            {
                ...
                else
                {
                    double dbl = double.Parse(this.GetType().GetProperty(columnName).GetValue(this).ToString());
                    bool required = (columnName == "SatPress" || columnName == "SteamProduction" ||
                        columnName == "SatTemp" || columnName == "WaterDensity" || columnName == "SteamDensity" ||
                        columnName == "WaterViscosity" || columnName == "SteamViscosity" ||
